...
@Component({
  selector: 'app-worksSharing',
  templateUrl: './worksSharing.component.html',
  styleUrls: ['./worksSharing.component.scss']
})
export class WorksSharingComponent implements OnInit {
  zoom: number = 14;
